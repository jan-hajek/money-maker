...
func (s *Service) countAvgAdxGainAdxLoss(
	...
	lastRSIPeriodsResults []interfaces.HistoryItem,
...
func (s *Service) countAvgAdxDiff(currentAdxDiff float.Float, lastPeriodsResults []interfaces.HistoryItem) float.Float {
